...
<div class="flex flex-col items-center justify-center grow h-screen">
  ...
  <form class="max-w-lg w-full space-y-6 p-10	bg-pink-500 rounded-lg shadow-md" method="post">
    ...
    <label class="input input-bordered flex items-center gap-2">
      ...
      <input class="grow" name="email" placeholder="Email" type="text"
    ...
    <label class="input input-bordered flex items-center gap-2">
      ...
      <input class="grow" name="password" placeholder="Wachtwoord" type="password" />
    </label>
    <div class="flex flex-row justify-between bg-yellow-300">
      <div class="">
        <input class="checkbox bg-base-100" type="checkbox" />
      </div>
      <div class="px-6">
        <label class="font-light text-gray-500 dark:text-gray-300" for="terms">Ik ga akkoord met de algemene voorwaarden
          van GGZoek</label>
      </div>
